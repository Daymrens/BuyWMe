...
class MyStoresScreen extends ConsumerWidget {
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Tap + to add your favorite stores',
  ...
  void _showEditStoreDialog(BuildContext context, WidgetRef ref, dynamic store) {
          ...
          TextButton(
            onPressed: () {
              if (nameController.text.isNotEmpty) {
                ...
                store.address = addressController.text.isEmpty ? null : addressController.text;
                store.save();
